...
<header>
        <nav>
            <div id="header">
                <ul class="nav">
                    <li><a href="../view/inicio.html">Inicio</a></li>
                    <li><a href="">Usuarios</a>
                                                  
                        <ul>
                            
                            <li><a href="altaUsuarioC.html">Crear Usuario</a></li>
                            <li><a href="listadosUsuariosC.php">Listado de Usuarios</a></li>
    ...
    <form class="needs-validation" novalidate action="../controller/altaPedido.php" method="POST">
      ...
      <div class="row">
       ...
       // $listProv = $dao->listarProvincias();
        //recorrer con for each , copiar lo de listadoPedidosC.php 
        //generar mediante un echo cada una de esas opciones: tomar id de provincia y poner como value
        //y el nombre de la provincia ponerlo en la lista
