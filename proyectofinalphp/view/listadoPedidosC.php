                        ...
                        <ul>
                            ...
                            <li><a href="">Pedidos</a>
                                <ul>
                                    ...
                                    <li><a href="listadoPedidosEC.php">Listado En Clases</a></li>
                                </ul>
                            </li>
                        </ul>
    ...
    <table class="table table-hover table-sm">
      ...
      <tbody>
        ...
        foreach ($listPed as $pedido) {
          ...
          <a href='updPedido.php?id=<?php echo $pedido->getIdPedido(); ?>'> <i class="fa fa-edit"></i> </a>
